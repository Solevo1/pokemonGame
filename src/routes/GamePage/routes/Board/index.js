...
const BoardPage = () => { 
    const {pokemons,addEnemies} = useContext(PokemonContext)
    ...
    useEffect(async()=>{
        ...
        addEnemies(player2Request.data);
        setPlayer2(()=>{
            ...
            <div className={s.board}>
                {
                    board.map(item=>(
                        ...
                        >
                            {
                                item.card && <PokemonCard {...item.card} isActive minimize possession={item.card.possession} />
                            }                            
                        </div>
                    ))
                }
