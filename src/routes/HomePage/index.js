...
const HomePage = () => {
  return ( 
    <>
         <Header
            title="Pokemon Game"
            descr="This is an interesting card game about Pokemons"
         />
          <Layout
            id={1}
            title="Rules"
          ...
          >
            <p>
            In the game two players face off against one another, one side playing as "blue", the other as "red" on a 3x3 grid.<br/>
